...
if __name__ == "__main__":
    try:
        ...
        if assertion is None or len(assertion.strip())==0:
            print("No assertion given")
            exit(1)
        try:
        ...
        print(f"Filtering sequences by size {max_length}")
        print("==================================================")
        filename = filter_size(filename, max_length)
        print(f"out: {filename}\n")
        print("Running MSA")
        print("==================================================")
